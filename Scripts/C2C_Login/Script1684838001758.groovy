...
WebUI.setText(findTestObject('Object Repository/Page_Connect2Clinic/input_Login to Virtual Clinic_OTP-input'), GlobalVariable.Username)

WebUI.click(findTestObject('Object Repository/Page_Connect2Clinic/button_Continue'))

WebUI.setText(findTestObject('Object Repository/Page_Connect2Clinic/input_Edit_password-input'), GlobalVariable.Password)
